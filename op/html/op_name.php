...
$recipient_query = "SELECT atlantian_id, sca_name, alternate_names, name_reg_date, blazon, device_reg_date, gender, deceased, revoked, revoked_date, device_file_name " .
                   "FROM $DBNAME_AUTH.atlantian " .
                   "WHERE (sca_name LIKE " . quote_begins_like($letter) . $sql_extra . ") " .
                   "AND atlantian_id IN (SELECT DISTINCT atlantian_id FROM $DBNAME_OP.atlantian_award) " .
                   "ORDER BY sca_name";
?>
