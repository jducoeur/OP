...
<table align="center" width="100%" cellpadding="5" cellspacing="0" border="0" summary="">
   <tr>
      <td width="100%">
      ...
      <table align="center" width="100%" cellpadding="5" cellspacing="0" border="1" summary="">
         <tr>
            ...
            <td class="data">The Royal peers of Atlantia receive a Patent of Arms provided the Monarch stepping down does not already have one. The Queens or Consorts of Atlantia are inducted into the Order of the Rose 
            upon completion of Their first reign.</td>
         </tr>
         <tr>
            <th width="40%" align="center" valign="middle" class="title">Landed Baronage</th>
            <td class="data">In Atlantia, the Landed Baronage is Granted Arms at their investiture provided they do not already have a GoA.</td>
         </tr>
      </table>
      <br/><br/>
      <table align="center" width="100%" cellpadding="5" cellspacing="0" border="1" summary="">
         ...
         <tr>
            ...
            The Academie d'Espee was originally a non-armigerous award, created in April 1993.  With the signing of the White Scarf Treaty, the award was closed on April 20, 1996, 
            and the new Order of the White Scarf, an AoA level order, replaced it.  As of October 1, 2001, the White Scarf became a Grant Level, polling order. 
            TRM Cuan and Arianwen did confer upon Niall McKennett the first on April 3, 1993, when it was named the Academie d'Espee. He was made a companion of the White Scarf along with 
            the other 13 members of the Academie on April 20, 1996, by order of TRM Galmr and Katharina.</td>
         </tr>
         <tr>
      ...
      <table align="center" width="100%" cellpadding="5" cellspacing="0" border="1" summary="">
         ...
         <tr>
            <th width="40%" align="center" valign="middle"><img src="<?php echo $AWARD_IMAGE_DIR; ?>no_badge.gif" width="130" height="130" alt="No Badge Registered to Date" border="0"/></th>
         ...
         <tr>
            <th width="40%" align="center" valign="middle"><img src="<?php echo $AWARD_IMAGE_DIR; ?>no_badge.gif" width="130" height="130" alt="No Badge Registered to Date" border="0"/><!--<img src="<?php echo $AWARD_IMAGE_DIR; ?>sea_dragon.gif" width="130" height="130" alt="Badge for the Order of the Sea Dragon" border="0"/>--></th>
         ...
         <tr>
            <th width="40%" align="center" valign="middle"><img src="<?php echo $AWARD_IMAGE_DIR; ?>no_badge.gif" width="130" height="130" alt="No Badge Registered to Date" border="0"/></th>
            <td class="data"><b>The Order of the King's Lancers:</b> Honors and recognizes those who have distinguished themselves and shown excellence in the pursuit of equestrian activities, in service or valor.
            The King's Lancers is an Award of Arms level, non-polling order, created in January 2007. 
            <!--The first King's Lancers was conveyed to ? by Their Royal Majesties ? and ? at ? on ? ?, 2007.--></td>
         </tr>
      </table>
      <br/><br/>
      <table align="center" width="100%" cellpadding="5" cellspacing="0" border="1" summary="">
      ...
      <table align="center" width="100%" cellpadding="5" cellspacing="0" border="1" summary="">
         ...
         <tr>
            <th width="40%" align="center" valign="middle"><img src="<?php echo $AWARD_IMAGE_DIR; ?>no_badge.gif" width="130" height="130" alt="No Badge Registered to Date" border="0"/><!--<img src="<?php echo $AWARD_IMAGE_DIR; ?>fountain.gif" width="130" height="130" alt="Badge for the Award of the Fountain" border="0"/>--></th>
      ...
      <table align="center" width="100%" cellpadding="5" cellspacing="0" border="1" summary="">
         ...
         <tr>
            ...
            <td class="data"><b>The Sea Urchin:</b> Honors and recognizes those children (age 12 and under) who have distinguished themselves by their contributions to the Kingdom of Atlantia. 
            ...
            The first Sea Urchin was given to Elizabeth of Marinus on the September 26, 1992, at the hands of TRM Steffan and Twila.</td>
         </tr>
         <tr>
            ...
            <td class="data"><b>The Hippocampus:</b> Honors and recognizes those young people (from ages 10 to 17), whose service and contributions to the Kingdom of Atlantia have distinguished them in the eyes of 
            the Crown and Kingdom. 
            This award was created in August 1998.  
            Wil Elmsford was the first recipient of this award at Pennsic, on August 12, 1998, as given by TRM Michael and Seonaid.</td>
         </tr>
         <!--
         <tr>
            <th width="40%" align="center" valign="middle"><img src="<?php echo $AWARD_IMAGE_DIR; ?>no_badge.gif" width="130" height="130" alt="No Badge Registered to Date" border="0"/></th>
            <td class="data"><b>The Award of the Golden Gazelle:</b> Honors and recognizes those young people (up to and including the age of 17) who have distinguished themselves by acts of courtesy. 
            ...
            The Golden Gazelle was closed in September 2006.
            </td>
         </tr>
         -->
         <tr>
            <th width="40%" align="center" valign="middle"><img src="<?php echo $AWARD_IMAGE_DIR; ?>no_badge.gif" width="130" height="130" alt="No Badge Registered to Date" border="0"/></th>
            <td class="data"><b>The Award of the Sea Tiger:</b>  Honors and recognizes those young people (up to and including the age of 17) who have distinguished themselves by acts of valor 
            and chivalry on the Youth Combat field. 
            This award was established by TRM Michael and Seonaid in August, 2006.  They gave the first Sea Tiger to Jasmine Mcklinchey during Their Last Court on September 2, 2006.</td>
         </tr>
         <tr>
            <th width="40%" align="center" valign="middle"><img src="<?php echo $AWARD_IMAGE_DIR; ?>no_badge.gif" width="130" height="130" alt="No Badge Registered to Date" border="0"/></th>
            <td class="data"><b>The Award of the Alcyon :</b> Honors and recognizes those young people (up to and including the age of 17) who have distinguished themselves by their labors and
      ...
      <br/><br/>
      Last updated by Signora Cassandra Arabella Giordani, January 2007.
      </p>
      </td>
   </tr>
</table>
