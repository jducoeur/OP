...
$query = "SELECT university.*, branch.*, branch_type.branch_type " .
         "FROM $DBNAME_UNIVERSITY.university LEFT OUTER JOIN $DBNAME_BRANCH.branch ON university.branch_id = branch.branch_id " .
...
?>
   ...
   <p style="text-align:center"><a href="class.php?mode=<?php echo $MODE_ADD; ?>&amp;university_id=<?php echo $university_id; ?>">Add Class</a></p>
<?php
...
?>
   <tr>
      ...
      <td bgcolor="<?php echo $bgcolor; ?>"><a href="class.php?university_id=<?php echo $university_id; ?>&amp;course_id=<?php echo $course_id; ?>"><?php echo htmlentities($title); ?></a></td>
...
db_disconnect($link);
?>
<p style="text-align:center"><a href="university.php">Other Session Catalogs</a></p>
<?php
}
// Not authorized
else
